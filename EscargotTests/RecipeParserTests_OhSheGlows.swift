//
//  RecipeParserTests_OhSheGlows.swift
//  EscargotTests
//
...
class RecipeParserTests_OhSheGlows: XCTestCase {
    ...
    func testInit() {
        ...
        XCTAssert(parser.url.absoluteString == RecipeParserTests_OhSheGlows.ohSheGlowsOatmealPath)
    }
	...
	func testInit2() {
		...
		XCTAssert(parser.url.absoluteString == RecipeParserTests_OhSheGlows.ohSheGlowsCinnamonRollsPath)
	}
...
extension RecipeParserTests_OhSheGlows {
	func ohSheGlowsOatmealRecipeParser() -> RecipeParser? {
		guard let url = URL(string: RecipeParserTests_OhSheGlows.ohSheGlowsOatmealPath) else {
	...
	func ohSheGlowsCinnamonRollsParser() -> RecipeParser? {
		guard let url = URL(string: RecipeParserTests_OhSheGlows.ohSheGlowsCinnamonRollsPath) else {
			XCTAssert(false, "Failed to create a URL")
			return nil
